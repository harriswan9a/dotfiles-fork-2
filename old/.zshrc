...
plugins=(kubectl minikube extract sublime vscode git git-flow textmate ruby autojump osx mvn gradle adb docker tmux gcloud)
...
# source /Users/harriswang/google-cloud-sdk/completion.zsh.inc

export PATH="$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:${HOME}/.gem/ruby/2.6.0/bin:$PATH"
